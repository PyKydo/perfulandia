...
class EnvioServiceTest {
    ...
    void shouldListAllEnvios() {
        ...
        List<EnvioDTO> result = envioService.findAll();
    ...
    void shouldFindEnvioById() {
        ...
        EnvioDTO dto = envioService.findById(1L);
    ...
    void shouldCreateEnvio() {
        ...
        EnvioDTO dto = envioService.save(envio);
        assertThat(dto.getDireccion()).isEqualTo("Calle 1");
    ...
    void shouldUpdateEnvio() {
        ...
        EnvioDTO dto = envioService.updateById(1L, updated);
    ...
    void shouldConvertToDTO() {
        EnvioDTO dto = envioService.convertToDTO(envio);
        assertThat(dto.getDireccion()).isEqualTo("Calle 1");

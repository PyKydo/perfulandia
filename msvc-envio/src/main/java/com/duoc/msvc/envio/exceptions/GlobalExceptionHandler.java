package com.duoc.msvc.envio.exceptions;

import com.duoc.msvc.envio.dtos.ErrorDTO;
...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDTO> handleEnvioException(EnvioException ex) {
        logger.error("GlobalExceptionHandler - EnvioException: {}", ex.getMessage());
